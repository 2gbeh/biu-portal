...
@section('content')
    ...
    <x-form.guest action="user/student/login">
    ...
    <p class="mt-4 nav-links">
        <a class="{{ trans('tw.nav-link') }}" href="{{ url('user/student/forgot-password') }}">
            Forgot your password?
        </a> <br />
        <a class="{{ trans('tw.nav-link') }}" href="{{ url('user/student/register') }}">
