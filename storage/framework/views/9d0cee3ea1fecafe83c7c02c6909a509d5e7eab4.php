...
<?php endif; ?>
    ...
    <p class="mt-4 nav-links">
        <a class="<?php echo e(trans('tw.nav-link')); ?>" href="<?php echo e(url('user/student/login')); ?>">
...
<?php echo $__env->make('layouts.guest.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vudo\resources\views/user/student/forgot-password.blade.php ENDPATH**/ ?>