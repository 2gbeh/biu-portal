    ...
    <div class="mb-3">
        ...
        <?php switch($item['type']):
            ...
            <?php case ('select'): ?>
                ...
                ]) ?>" id="<?php echo e($item['id'] ?? $item['name']); ?>" name="<?php echo e($item['name']); ?>"
                    <?php echo e($item['constraint']); ?>>
            ...
            <?php default: ?>
                <?php if(isset($item['datalist'])): ?>
                    <input class="form-control" type="<?php echo e($item['type']); ?>" id="<?php echo e($item['id']); ?>"
                        name="<?php echo e($item['name']); ?>" value="<?php echo e($item['value']); ?>" placeholder="<?php echo e($item['placeholder']); ?>"
                        list="dl-<?php echo e($item['name']); ?>" <?php echo e($item['constraint']); ?> />
                ...
                <?php else: ?>
                    <input class="form-control" type="<?php echo e($item['type']); ?>" id="<?php echo e($item['id']); ?>"
                        name="<?php echo e($item['name']); ?>" value="<?php echo e($item['value']); ?>" placeholder="<?php echo e($item['placeholder']); ?>"
                        min="<?php echo e($item['min']); ?>" max="<?php echo e($item['max']); ?>" step="<?php echo e($item['step']); ?>"
                        <?php echo e($item['constraint']); ?> />
                <?php endif; ?>
        <?php endswitch; ?>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\vudo\resources\views/components/form/control.blade.php ENDPATH**/ ?>