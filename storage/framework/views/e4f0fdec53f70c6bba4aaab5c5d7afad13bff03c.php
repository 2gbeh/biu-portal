...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.guest','data' => ['action' => 'admin/login']]); ?>
<?php $component->withName('form.guest'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['action' => 'admin/login']); ?>
...
<?php endif; ?>
    ...
    <p class="mt-4 nav-links">
        <a class="<?php echo e(trans('tw.nav-link')); ?>" href="<?php echo e(url('admin/forgot-password')); ?>">
            Forgot your password?
        </a> <br />
        <a class="<?php echo e(trans('tw.nav-link')); ?>" href="<?php echo e(url('admin/register')); ?>">
            Don't have an account? Sign up
        </a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.guest.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vudo\resources\views/auth/login.blade.php ENDPATH**/ ?>