...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.guest','data' => ['action' => 'user/applicant/login']]); ?>
<?php $component->withName('form.guest'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['action' => 'user/applicant/login']); ?>
...
<?php endif; ?>
    ...
    <p class="mt-4 nav-links">
        <a class="<?php echo e(trans('tw.nav-link')); ?>" href="<?php echo e(url('user/applicant/forgot-password')); ?>">
            Forgot your password?
        </a> <br />
        <a class="<?php echo e(trans('tw.nav-link')); ?>" href="<?php echo e(url('user/applicant/register')); ?>">
            Don't have an account? Sign up
        </a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.guest.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vudo\resources\views/user/applicant/login.blade.php ENDPATH**/ ?>