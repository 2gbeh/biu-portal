...
<a onclick="handleButtonOauth(this)" class="<?php echo e(trans('tw.btn.oauth')); ?>" data-url="<?php echo e($button_oauth_url); ?>">
    <img src="<?php echo e(asset($button_oauth_img['src'])); ?>" width="<?php echo e($button_oauth_img['width']); ?>" alt="" /> &nbsp;
    <?php echo e($button_oauth_txt); ?>

</a>
<?php /**PATH C:\xampp\htdocs\vudo\resources\views/shared/button/oauth.blade.php ENDPATH**/ ?>