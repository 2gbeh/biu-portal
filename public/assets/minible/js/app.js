!(function (n) {
    ...
    if (true) {
        //typeof t !== "undefined" && typeof e !== "undefined") {
        function e(t) {
        ...
        n("#side-menu").metisMenu(),
            ...
            n(document).ready(function () {
                ...
                0 < n("#sidebar-menu").length &&
                    ...
                    300 <
                        (t = n("#sidebar-menu .mm-active .active").offset()
                            .top) &&
                    ((t -= 300),
            ...
            n(document).on("click", "body", function (t) {
                0 <
                    n(t.target).closest(".right-bar-toggle, .right-bar")
                        .length || n("body").removeClass("right-bar-enabled");
            }),
            (function () {
                    ...
                    for (
                        ...
                        t[e].onclick = function (t) {
                            "#" === t.target.getAttribute("href") &&
                                (t.target.parentElement.classList.toggle(
                                    "active"
                                ),
            ...
            (function () {
                ...
                var a = n(this).attr("data-delay")
                        ? n(this).attr("data-delay")
                        : 100,
                    o = n(this).attr("data-time")
            ...
            window.sessionStorage &&
                ((d = sessionStorage.getItem("is_visited"))
                    ? n("#" + d).prop("checked", !0)
            ...
            n("#mode-setting-btn").on("click", function (t) {
                r.hasAttribute("data-layout-mode") &&
                "dark" == r.getAttribute("data-layout-mode")
                    ? (document.body.setAttribute("data-layout-mode", "light"),
                      document.body.setAttribute("data-topbar", "light"),
                      document.body.setAttribute("data-sidebar", "light"),
                      (r.hasAttribute("data-layout") &&
                          "horizontal" == r.getAttribute("data-layout")) ||
                          document.body.setAttribute("data-sidebar", "light"),
            ...
            r.hasAttribute("data-layout") &&
            "horizontal" == r.getAttribute("data-layout")
                ? (e("layout-horizontal"), n(".sidebar-setting").hide())
                : e("layout-vertical"),
            r.hasAttribute("data-layout-mode") &&
            "dark" == r.getAttribute("data-layout-mode")
                ? e("layout-mode-dark")
                : e("layout-mode-light"),
            r.hasAttribute("data-layout-size") &&
            "boxed" == r.getAttribute("data-layout-size")
                ? e("layout-width-boxed")
                : e("layout-width-fuild"),
            r.hasAttribute("data-topbar") &&
            "dark" == r.getAttribute("data-topbar")
                ? e("topbar-color-dark")
                : e("topbar-color-light"),
            r.hasAttribute("data-sidebar-size") &&
            "sm" == r.getAttribute("data-sidebar-size")
                ? e("sidebar-size-small")
                : r.hasAttribute("data-sidebar-size") &&
                  "md" == r.getAttribute("data-sidebar-size")
                ? e("sidebar-size-compact")
                : e("sidebar-size-default"),
            r.hasAttribute("data-sidebar") &&
            "colored" == r.getAttribute("data-sidebar")
                ? e("sidebar-color-colored")
                : r.hasAttribute("data-sidebar") &&
                  "dark" == r.getAttribute("data-sidebar")
                ? e("sidebar-color-dark")
                : e("sidebar-color-light"),
