...
use App\Traits\ProfileControllerTrait;
...
{
    use ControllerTrait, ProfileControllerTrait;

    protected $view = 'profile', $base = 'Home';

    public function __construct(Request $request, Route $route)
    {
        self::construct_($request, $route);

        $this->user_id = RouteTrait::isTenant(6, 1, 2);
    ...
    {
        //
        $breadcrumb = ['breadcrumb_page' => 'My Profile', 'breadcrumb_base' => $this->base];
